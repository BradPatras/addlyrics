...
| Before: no lyrics 😞             | After: lyrics 😎               |
| -------------------------------- | ------------------------------ |
| ![before](screencaps/before.png) | ![after](screencaps/after.png) |
...
# running this will search the `Muse/` directory (and it's sub-directories) for mp3s, fetch lyrics for all found, and apply the lyric data to the files.
```
...
This tool makes use of the awesome free lyrics api made by [@tranxuanthang](https://github.com/tranxuanthang) and their [lrclib project](https://github.com/tranxuanthang/lrclib).
